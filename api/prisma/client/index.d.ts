...
/**
   ...
   * `prisma.carros`: Exposes CRUD operations for the **Carros** model.
    ...
    * ```
    */
  get carros(): Prisma.CarrosDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type CarrosAggregateArgs = {
    /**
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<CarrosOrderByWithRelationInput>
    /**
  ...
  export type CarrosGroupByArgs = {
    where?: CarrosWhereInput
    orderBy?: Enumerable<CarrosOrderByWithAggregationInput>
    by: Array<CarrosScalarFieldEnum>
  ...
  type GetCarrosGroupByPayload<T extends CarrosGroupByArgs> = PrismaPromise<
    Array<
      PickArray<CarrosGroupByOutputType, T['by']> &
        {
  ...
  export type CarrosGetPayload<S extends boolean | null | undefined | CarrosArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Carros :
    S extends undefined ? never :
    S extends { include: any } & (CarrosArgs | CarrosFindManyArgs)
    ? Carros 
    : S extends { select: any } & (CarrosArgs | CarrosFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof Carros ? Carros[P] : never
  } 
      : Carros


  type CarrosCountArgs = Merge<
    Omit<CarrosFindManyArgs, 'select' | 'include'> & {
      select?: CarrosCountAggregateInputType | true
    }
  >

  export interface CarrosDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends CarrosFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, CarrosFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Carros'> extends True ? Prisma__CarrosClient<CarrosGetPayload<T>> : Prisma__CarrosClient<CarrosGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends CarrosFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, CarrosFindUniqueOrThrowArgs>
    ): Prisma__CarrosClient<CarrosGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends CarrosFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, CarrosFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Carros'> extends True ? Prisma__CarrosClient<CarrosGetPayload<T>> : Prisma__CarrosClient<CarrosGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends CarrosFindFirstOrThrowArgs>(
      args?: SelectSubset<T, CarrosFindFirstOrThrowArgs>
    ): Prisma__CarrosClient<CarrosGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends CarrosFindManyArgs>(
      args?: SelectSubset<T, CarrosFindManyArgs>
    ): PrismaPromise<Array<CarrosGetPayload<T>>>
     ...
     * 
    **/
    create<T extends CarrosCreateArgs>(
      args: SelectSubset<T, CarrosCreateArgs>
    ): Prisma__CarrosClient<CarrosGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends CarrosCreateManyArgs>(
      args?: SelectSubset<T, CarrosCreateManyArgs>
     ...
     * 
    **/
    delete<T extends CarrosDeleteArgs>(
      args: SelectSubset<T, CarrosDeleteArgs>
    ): Prisma__CarrosClient<CarrosGetPayload<T>>
     ...
     * 
    **/
    update<T extends CarrosUpdateArgs>(
      args: SelectSubset<T, CarrosUpdateArgs>
    ): Prisma__CarrosClient<CarrosGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends CarrosDeleteManyArgs>(
      args?: SelectSubset<T, CarrosDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends CarrosUpdateManyArgs>(
      args: SelectSubset<T, CarrosUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends CarrosUpsertArgs>(
      args: SelectSubset<T, CarrosUpsertArgs>
    ): Prisma__CarrosClient<CarrosGetPayload<T>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends CarrosAggregateArgs>(args: Subset<T, CarrosAggregateArgs>): PrismaPromise<GetCarrosAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, CarrosGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCarrosGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export class Prisma__CarrosClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  /**
   * Carros base type for findUnique actions
   */
  export type CarrosFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Carros
     * 
    **/
    select?: CarrosSelect | null
    /**
   ...
   * Carros findUnique
   */
  export interface CarrosFindUniqueArgs extends CarrosFindUniqueArgsBase {
   /**
   ...
   */
  export type CarrosFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Carros
     * 
    **/
  ...
  /**
   * Carros base type for findFirst actions
   */
  export type CarrosFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Carros
     * 
    **/
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<CarrosScalarFieldEnum>
  }

  /**
   * Carros findFirst
   */
  export interface CarrosFindFirstArgs extends CarrosFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
   ...
   */
  export type CarrosFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Carros
     * 
    **/
   ...
   * Carros findMany
   */
  export type CarrosFindManyArgs = {
    /**
     * Select specific fields to fetch from the Carros
     * 
    **/
   ...
   * Carros createMany
   */
  export type CarrosCreateManyArgs = {
    /**
     * The data used to create many Carros.
     * 
    **/
    data: Enumerable<CarrosCreateManyInput>
   ...
   * Carros updateMany
   */
  export type CarrosUpdateManyArgs = {
    /**
   ...
   * Carros deleteMany
   */
  export type CarrosDeleteManyArgs = {
    /**
     * Filter which Carros to delete
     * 
    **/
  ...
  export type CarrosWhereInput = {
    AND?: Enumerable<CarrosWhereInput>
    OR?: Enumerable<CarrosWhereInput>
    NOT?: Enumerable<CarrosWhereInput>
    id?: IntFilter | number
    placa?: StringFilter | string
    ano?: IntFilter | number
    modelo?: StringFilter | string
    ativo?: BoolFilter | boolean
    marca?: StringFilter | string
  }
  ...
  export type CarrosWhereUniqueInput = {
    id?: number
  }
  ...
  export type CarrosScalarWhereWithAggregatesInput = {
    AND?: Enumerable<CarrosScalarWhereWithAggregatesInput>
    OR?: Enumerable<CarrosScalarWhereWithAggregatesInput>
    NOT?: Enumerable<CarrosScalarWhereWithAggregatesInput>
    ...
    marca?: StringWithAggregatesFilter | string
  }
